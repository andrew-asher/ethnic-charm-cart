...
const defaultCategories: AdminCategory[] = [
  { id: 'cat-tops', name: 'Tops', description: 'Stylish short tops, kurtis & fusion wear', image: '', order: 1, visible: true, subcategories: [{ id: 'sub-short-tops', name: 'Short Tops', order: 1 }, { id: 'sub-kurti', name: 'Kurti (Short / Long)', order: 2 }, { id: 'sub-indo-western', name: 'Indo-Western Tops', order: 3 }, { id: 'sub-crop-tops', name: 'Ethnic Crop Tops', order: 4 }] },
...
const defaultComboOffers: ComboOffer[] = [
  {
    id: 'combo-1',
    title: 'Festive Saree + Jimmiki Bundle',
    description: 'Celebrate the festive season with our Ruby Heritage Saree paired with traditional Temple Jimmiki Earrings — the perfect Deepavali look.',
    image: '',
  ...
  {
    id: 'combo-2',
    title: 'Grand Gown + Temple Chain Set',
    description: 'Make a grand entrance this festive season — our Maroon Maharani Gown with the Heritage Temple Chain for celebrations.',
    image: '',
  ...
  {
    id: 'combo-3',
    title: 'Black Top + Royal Ear Piece Set',
    description: 'Festive fusion style — our Black Zari Short Top with the Royal Ear Piece Set for a chic ethnic celebration look.',
    image: '',
...
const ADMIN_DATA_VERSION = 'v6_tops_subcategories';
