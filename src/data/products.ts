...
export const products: Product[] = [
  // Tops
  {
    ...
    image: top1,
    images: [top1],
    description: 'A stunning terracotta kurti top with intricate embroidery inspired by Eelam textile traditions. Crafted from premium cotton blend fabric.',
    qualityNote: 'Premium cotton blend with hand-finished embroidery details.',
    sizes: ['XS', 'S', 'M', 'L', 'XL'],
    colors: ['Terracotta', 'Dusty Mauve'],
  ...
  },
  {
    ...
    image: top2,
    images: [top2],
    description: 'An ivory tunic adorned with rich gold embroidery, perfect for festive occasions and elegant gatherings.',
  ...
  },
  {
    ...
    image: top3,
    images: [top3],
    description: 'A breezy peach-toned top featuring delicate floral prints inspired by Sri Lankan botanical gardens.',
  ...
  {
    id: 'top-4',
    name: 'Midnight Jaffna Top',
    subtitle: 'Navy Embroidered Kurti',
    price: 32,
    category: 'Tops',
    image: top4,
    images: [top4],
    description: 'A rich navy blue kurti with silver-toned embroidery inspired by Jaffna textile traditions.',
  ...
  {
    id: 'top-5',
    name: 'Mint Chikan Kurti',
    subtitle: 'Chikankari Embroidered Top',
    price: 38,
    category: 'Tops',
    image: top5,
    images: [top5],
    description: 'A fresh mint green kurti featuring delicate chikankari embroidery. Light and elegant for everyday wear.',
  ...
  {
    id: 'top-6',
    name: 'Rosé Heritage Top',
    subtitle: 'Embroidered Pink Kurti',
    price: 34,
    category: 'Tops',
    image: top6,
    images: [top6],
    description: 'A beautiful mauve pink kurti with tone-on-tone embroidery, perfect for semi-formal occasions.',
    qualityNote: 'Premium cotton blend with intricate embroidery work.',
    sizes: ['S', 'M', 'L', 'XL'],
    colors: ['Mauve Pink', 'Rose'],
    badge: 'Limited Stock',
  },
  // Gowns
  {
