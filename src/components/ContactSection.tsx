  ...
  <section id="contact" className="py-20 bg-blush-gradient">
    <div className="container mx-auto px-4">
      <div className="text-center mb-12">
        <p className="font-body text-primary text-sm tracking-[0.3em] uppercase mb-2">Get in Touch</p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-4xl mx-auto">
        <a
          ...
          className="flex flex-col items-center p-6 bg-card rounded-2xl card-product hover:border-primary border border-transparent transition-all group"
        >
          <MessageCircle className="w-8 h-8 text-sage mb-3 group-hover:scale-110 transition-transform" />
        ...
        <div className="flex flex-col items-center p-6 bg-card rounded-2xl card-product group">
          ...
          <p className="font-body text-sm text-muted-foreground text-center">London, UK & Sri Lanka</p>
        </div>
        <div className="flex flex-col items-center p-6 bg-card rounded-2xl card-product group">
          ...
          <p className="font-body text-sm text-muted-foreground text-center">London delivery & Sri Lanka shipping</p>
        </div>
      </div>
    </div>
  </section>
