          ...
          {visible.map((cat) => {
            ...
            return (
              <button
                ...
                className="group relative overflow-hidden rounded-2xl aspect-[3/4] shadow-lg hover:shadow-xl transition-all duration-500 hover:-translate-y-1"
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 text-left">
                  <h3 className="font-display text-xl sm:text-2xl font-bold text-primary-foreground mb-1">{cat.name}</h3>
