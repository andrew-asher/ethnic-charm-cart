...
const features = [
  { icon: Globe, title: 'Eelam Roots', desc: 'Handpicked from artisans in Sri Lanka' },
  ...
  { icon: Heart, title: 'Made with Love', desc: 'Celebrating our heritage & identity' },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="flex items-center gap-4 mt-4">
              ...
              <span className="font-body text-xs text-muted-foreground tracking-[0.3em] uppercase">Est. 2026 · London & Sri Lanka</span>
              <div className="h-px flex-1 bg-border" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            {features.map((f, i) => (
              <div
                key={f.title}
                className={`p-6 bg-card rounded-2xl card-product text-center group cursor-default ${i % 2 === 1 ? 'mt-6' : ''}`}
              >
